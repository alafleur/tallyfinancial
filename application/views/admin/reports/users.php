	...
	<tbody>		
		...
		<tr>
			...
			<td>
				...
				<?php if((int)$user['iSignupStep'] == 5){?><br><strong>A/C Balance:</strong> $<?=format_number($fChequingbalance, true)?><?php }?>
				<?php }?>
			</td>
			<td>
			...
			<td>
				...
				<strong>Current Bal:</strong> $<?=format_number($fTallyBalance, true)?><br>
				<strong>External Bal:</strong> $<?=format_number($fTotalTransfers, true)?><br>
				<strong>Total Savings:</strong> $<?=format_number($fTotalSaving, true)?><br>
				<strong>Avg Saving Amt:</strong> $<?=($iTotalTransactions > 0 ? format_number(($fTotalSaving/$iTotalTransactions), true) : '0.00')?><br>

		...
		<div class="row clearfix">
			...
			<div class="col-sm-8 col-md-8">
				...
				<div class="dash-box">
					...
					<p class="saving-balance color-h1">$ <?=format_number($fTotalSaving, true)?></p>
											
					<div class="row">
						<div class="col-md-6">
							<div class="hbox">
								<h5 class="align-center">Current Tally Balance</h5>
								<span class="highlight">$ <?=format_number($fTallyBalance, true)?></span>
							</div>
						</div>
						<div class="col-md-6">
							<div class="hbox">
								<h5 class="align-center">Tally Savings Transferred Out</h5>
								<span class="highlight">$ <?=format_number($fTotalTransfers, true)?></span>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="hbox">
								...
								<span class="highlight"><?php if($iTotalTransactions > 0){?>$ <?=format_number(($fTotalSaving/$iTotalTransactions), true)?><?php } else {?>0.00<?php }?></span>
							</div>
						</div>
						<div class="col-md-6">
							<div class="hbox">
					...
					<ul>
						...
						<li<?=(!$show_more && ($i+1) == $iLimit ? ' class="last"' : '')?>><strong>$ <?=format_number(abs($transaction['fSavingAmount']), true)?> saved</strong> on <?=date("F j, Y", strtotime($transaction['dtCreatedOn']))?></li>
						<?php } if($show_more){?>
